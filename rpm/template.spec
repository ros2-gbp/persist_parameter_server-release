...
%global pkg_name persist_parameter_server
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-persist-parameter-server
Version:        4.0.0
Release:        2%{?dist}
...
%changelog
* Wed May 13 2026 Tomoya Fujita <Tomoya.Fujita@sony.com> - 4.0.0-2
- Autogenerated by Bloom

* Wed Apr 29 2026 Tomoya Fujita <Tomoya.Fujita@sony.com> - 1.0.5-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Tomoya Fujita <Tomoya.Fujita@sony.com> - 1.0.5-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Tomoya Fujita <Tomoya.Fujita@sony.com> - 1.0.5-1
- Autogenerated by Bloom
